...
class DecimalFieldSpec extends ObjectBehavior
{
    function it_can_serialize_decimal_values()
    {
    ...
    function it_can_deserialize_decimal_values()
    {
        $this->deserialize("1")->shouldReturn(1.0);
        $this->deserialize("-1")->shouldReturn(-1.0);
